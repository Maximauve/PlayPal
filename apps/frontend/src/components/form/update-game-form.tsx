...
interface UpdateGameFormProps {
  formik: ReturnType<typeof useFormik<UpdateGamePayload>>;
}

export default function UpdateGameForm({ formik }: UpdateGameFormProps) {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <TextInput name='description' type='text'value={formik.values.description ?? undefined} label='admin.create.game.description' onChange={(e) => handleStringChange('description', e.target.value)} error={{ isError: !!formik.touched.description && !!formik.errors.description, message: formik.errors.description as WordingKey }} />
      ...
      <TextInput name='duration' type='text' value={formik.values.duration ?? undefined} label='admin.create.game.duration' onChange={(e) => handleStringChange('duration', e.target.value)} error={{ isError: !!formik.touched.duration && !!formik.errors.duration, message: formik.errors.duration as WordingKey }} />
      <TextInput name='brand' type='text' value={formik.values.brand ?? undefined} label='admin.create.game.brand' onChange={(e) => handleStringChange('brand', e.target.value)} error={{ isError: !!formik.touched.brand && !!formik.errors.brand, message: formik.errors.brand as WordingKey }} />
      <SelectInput
        id="tags"
        name="tags"
        label="Tags"
